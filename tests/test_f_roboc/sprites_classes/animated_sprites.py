...
from f_roboc.print_infos import show_infos as show_inf


class SpriteLoop(pygame.sprite.Sprite):
    """Cette classe crée des images qui s'animent sur place, en boucle."""
    ...
    def update(self):
        ...
        if self.current_time >= self.time_per_img[self.index]:
            ...
            if self.index == 0:
                show_inf("sprites_classes.animated_sprites",
                         "bg images: la boucle est bouclé.")
